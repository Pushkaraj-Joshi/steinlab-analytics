...
mph_filename = 'Onset-field-study- Mar_10_2026.mph'
...
for elec_ri in ext_elec_ri_list:
    ...
    for r_inner in r_inner_list:
        ...
        R_base = model.evaluate('R_base')
        alpha = model.evaluate('alpha')
        r_cap = R_base*np.cos(alpha)
...
plot_filename = f"V_Onset_Plot_annular_electrode_{mph_filename}_3.pdf"
